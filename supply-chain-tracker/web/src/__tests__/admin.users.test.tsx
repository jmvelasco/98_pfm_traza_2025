...
describe('Admin Users Page', () => {
  ...
  it('lists users with different statuses (pending and approved)', async () => {
    ...
    const users = [
      { address: '0x1111111111111111111111111111111111111111', role: 'Producer', status: UserStatus.Pending },
      { address: '0x2222222222222222222222222222222222222222', role: 'Factory', status: UserStatus.Approved },
      { address: '0x3333333333333333333333333333333333333333', role: 'Retailer', status: UserStatus.Rejected },
    ];
  ...
  it('allows approving a pending user and refetches list', async () => {
    ...
    const updatedUsers = [
      { address: '0x1111111111111111111111111111111111111111', role: 'Producer', status: UserStatus.Approved },
    ];
  ...
  it('shows an error if reject action fails', async () => {
    ...
    const pending = [
      { address: '0xabcdefabcdefabcdefabcdefabcdefabcdefabcd', role: 'Retailer', status: UserStatus.Pending },
    ];
